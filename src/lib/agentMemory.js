...
export const DEFAULT_MEMORIES = [
  ...
  {
    id: 'mem-07',
    category: 'إدارة المخزون وسلاسل الإمداد',
    title: 'جرد حركة المخزن الفعلي (8,693 صنف - سبتمبر 2026)',
    content: 'المستودع يحتوي على 39,233 قطعة غيار متوفرة موزعة على 8,693 صنفاً مسجلاً لهيونداي وكيا. هناك 2,082 صنف راكد بحاجة لحزم وعروض ترويجية لتسييله، و 2,186 صنف نافد من المخزون وله طلب نشط يتطلب أوامر شراء وتوريد عاجلة.',
    source: 'حركة مخزن الى شهر 9 2026.xlsx',
